...
Se verificó el correcto funcionamiento mostrando textos con anti-aliasing, barras de progreso animadas y colores a $\sim$30~FPS.
...
\subsection{Bloque de Sensores: Prueba del MAX30205}

\subsubsection{Descripción y funcionalidad}
Se implementó un driver inicial para el sensor de temperatura \textbf{MAX30205} \citep{max30205_ds}, operando en el bus I2C a la dirección \texttt{0x48}. El driver implementa inicialización y lectura de temperatura.

La lectura de datos accede al registro \texttt{TEMP (0x00)} \citep{max30205_ds}.

\subsubsection{Resultados}
Se verificó la comunicación I2C confirmando la lectura correcta del registro \texttt{PART\_ID (0xFF) = 0x15} \citep{max30205_ds}. Se obtuvieron lecturas de temperatura con variación al colocar el dedo sobre el sensor.
...
\subsubsection{Resultados}
Se verificó el correcto acceso a la base de datos con autenticación y autorización.
