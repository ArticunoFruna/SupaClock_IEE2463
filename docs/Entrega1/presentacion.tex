...
\begin{frame}{Arquitectura de Sistemas (Alto Nivel)}
    ...
    \end{block}
    \begin{center}
        \includegraphics[width=0.98\linewidth, height=0.65\textheight, keepaspectratio]{fig_0.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Subsistema de Energía}
    \begin{columns}[c]
        ...
        \begin{column}{0.65\textwidth}
            \includegraphics[width=\linewidth, height=0.85\textheight, keepaspectratio]{fig_1.pdf}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Adquisición y Ruteo de Señales Computacionales}
    \begin{columns}[c]
        ...
        \end{column}
        \begin{column}{0.65\textwidth}
            \includegraphics[width=\linewidth, height=0.85\textheight, keepaspectratio]{fig_2.pdf}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Ingeniería de Firmware RTOS (Tiempo Real)}
    \begin{columns}[c]
        ...
        \end{column}
        \begin{column}{0.65\textwidth}
            \includegraphics[width=\linewidth, height=0.85\textheight, keepaspectratio]{fig_3.pdf}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Ecosistema Telemétrico (App y Nube Integrada)}
    ...
    \end{block}
    \begin{center}
        \includegraphics[width=0.95\linewidth, height=0.9\textheight, keepaspectratio]{fig_4.pdf}
    \end{center}
\end{frame}
