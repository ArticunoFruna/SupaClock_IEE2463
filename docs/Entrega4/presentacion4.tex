...
\begin{frame}{Estado del proyecto al 90\%}
    ...
    \begin{tabular}{p{2.6cm}p{4.3cm}p{4.3cm}p{1.5cm}}
        ...
        Machine Learning & 3 clases corriendo en Core 1, validaci\'on clean/noisy. & A\~nadir escaleras (4\textsuperscript{a} clase) y data augmentation. & \warnstate \\
        PCB final & Carrier validado; versiones v3/v4 para JLCPCB. & DRC final, pedido, ensamble y bring-up de placa en China. & \warnstate \\
...
\begin{frame}{Arquitectura integrada actualizada}
    \begin{columns}[T]
        ...
        \begin{tabular}{@{}l p{2.7cm}@{}}
            ...
            TinyML HAR & \textbf{Integrado} y validado \\
