...
\begin{frame}{Objetivo de esta entrega}
    \begin{columns}[T]
        ...
        \begin{itemize}\itemsep0.16cm
            ...
            \item Desarrollo de \textbf{carcasa param\'etrica}.
...
\begin{frame}{Dise\~no final de PCB para prototipo}
    \begin{columns}[T]
        ...
        \column{0.52\textwidth}
        \centering
        \includegraphics[page=1,width=2\linewidth]{SupaClock_Carrier_v1_pcb_placement.pdf}
        \vspace{0.05cm}\newline
...
\begin{frame}{Pipeline de Datos e Integraci\'on en Firmware}
    \begin{columns}[T]
        ...
        \end{tikzpicture}
        \vspace{0.15cm}
        \begin{alertblock}{Ventaja de la Clase Ca\'ida Integrada}
            \scriptsize
            Al clasificar la ca\'ida directamente dentro del softmax del modelo entrenado, se delega al aprendizaje profundo la capacidad de reconocer perfiles complejos de aceleraci\'on-giroscopio, eliminando el ajuste manual de heur\'isticas r\'igidas de impacto y free-fall.
        \end{alertblock}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{itemize}\itemsep0.12cm
            \item \textbf{Fusi\'on PPG + IMU}:
                ...
                \end{itemize}
            \item \textbf{Calibraci\'on y Personalizaci\'on}:
                \begin{itemize}\scriptsize\itemsep0.05cm
                    \item Habilitar un proceso de calibraci\'on local ``en caliente'' para ajustar umbrales de activaci\'on espec\'ificos según el peso y patrón de marcha del usuario.
                \end{itemize}
        \end{itemize}
        ...
        \begin{itemize}\itemsep0.12cm
            \item \textbf{Captura de Datos Reales}:
                ...
                \end{itemize}
            \item \textbf{Optimizaci\'on de Pesos}:
                \begin{itemize}\scriptsize\itemsep0.05cm
                    \item Explorar t\'ecnicas de cuantizaci\'on selectiva e introducci\'on de pesos dispersos (pruning) para reducir a\'un m\'as la huella del modelo en Flash, buscando bajar de los actuales $\sim$58\,KB.
                \end{itemize}
        \end{itemize}
    \end{columns}
\end{frame}
