...
\node[energy, above=0.6cm of usbc] (lipo) {Bater\'ia LiPo 3.7\,V\\\textbf{100\%} (Seeed S3 SMD)};
...
\node[blockPart, right=0.8cm of pcb] (ml) {TinyML (CNN 1D)\\\textbf{80\%} (Falta capt. datos)};
