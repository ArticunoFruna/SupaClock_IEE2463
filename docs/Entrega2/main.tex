...
\begin{itemize}
    ...
    \item \textbf{PCB SMD propia}: se completó la primera versión del esquemático en KiCad
    (\texttt{hardware/PCB\_Prototipo}) incluyendo la sección de potencia, los footprints
...
del consumo medio se realizará sobre la plataforma definitiva Seeed XIAO ESP32-S3 con un
INA219 a alta tasa de muestreo o un \textit{coulomb counter} dedicado.
...
\begin{enumerate}
    ...
    reboot y deep sleep, verificar que ambos valores sobreviven. Borrar NVS
