...
\begin{frame}{Tabla de gastos referencial}
    ...
    \begin{tabular}{p{4.2cm}p{2.0cm}p{2.2cm}p{2.2cm}}
        ...
        MAX30102 & 1 & 5.000 & BPM/SpO\textsubscript{2} \\
        AD8232 & 1 & 5.000 & ECG \\
        BMI160 & 1 & 4.000 & IMU \\
        ...
        \midrule
        \textbf{Total referencial} & & \textbf{81.000} & \\
        \bottomrule
    \end{tabular}
    \vspace{0.18cm}
    \begin{minipage}{0.82\textwidth}
        \centering
        \scriptsize Valores referenciales para presentar orden de magnitud; reemplazar por compras reales si se requiere cierre contable.
    \end{minipage}
\end{frame}
