...
\newcommand{\FechaEntrega}{11 de julio de 2026}
...
\begin{center}
    {\huge \textbf{\TituloInforme}}\\[0.4cm]
...
\begin{center}
    \includegraphics[width=0.55\textwidth]{supaclock_logo_rayo.pdf}
\end{center}
...
\hrule
\vspace{0.4cm}
\noindent\textbf{\'Area del proyecto:} Sistemas de informaci\'on\\[0.2cm]
\textbf{Integrantes:} \Integrantes\\[0.2cm]
